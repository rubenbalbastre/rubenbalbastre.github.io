  ...
  <div>
    <div class="skill-groups">
      <div class="skill-group">
        <h3>AI / ML</h3>
        <p class="skill-list"><span>LLMs</span><span>RAG</span><span>LLM post-training</span><span>SFT</span><span>RLVR</span><span>PINNs</span><span>LLM evaluation</span><span>Multi-agent systems</span><span>Time series forecasting</span><span>Knowledge graphs</span><span>Optimization</span><span>Simulations</span></p>
      </div>
      <div class="skill-group">
        <h3>Frameworks</h3>
        <p class="skill-list"><span>PyTorch</span><span>Hugging Face Transformers</span><span>TRL</span><span>XGBoost</span></p>
      </div>
      <div class="skill-group">
        <h3>LLM & Agent Tooling</h3>
        <p class="skill-list"><span>LangGraph</span><span>OpenAI SDK</span><span>FAISS</span><span>ChromaDB</span><span>Langfuse</span></p>
      </div>
      <div class="skill-group">
        <h3>Cloud & Data</h3>
        <p class="skill-list"><span>AWS SageMaker</span><span>AWS Glue</span><span>Azure Databricks</span><span>Azure Functions</span><span>Palantir Foundry</span></p>
      </div>
      <div class="skill-group">
        <h3>Programming</h3>
        <p class="skill-list"><span>Python</span><span>PySpark</span><span>Julia</span><span>SQL</span></p>
      </div>
      <div class="skill-group">
        <h3>Software & MLOps</h3>
        <p class="skill-list"><span>Docker</span><span>Weights & Biases</span><span>MLflow</span><span>CI/CD</span><span>OOP software design</span></p>
      </div>
    </div>
  </div>
</section>
